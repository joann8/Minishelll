...
/*   Updated: 2021/05/04 15:56:04 by jacher           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_up_arrow(char **screen, char **user_input, t_list *log,
			unsigned int *i);
int		ft_down_arrow(char **screen, char **user_input, t_list *log,
			unsigned int *i);
